    ...
    public static class SessionContext
    {
        ...
        public static bool Create(int userCode, string userID, int braCode)
        {
            try
            {
                ...
                SqlParameter[] inPara = new SqlParameter[4];
                inPara[0] = new SqlParameter("@userCode", userCode);
                inPara[1] = new SqlParameter("@userID", userID);
                inPara[2] = new SqlParameter("@braCode", braCode);
                inPara[3] = new SqlParameter("@machineName", Environment.MachineName);

                SqlParameter outPara = new SqlParameter("@sessionToken", SqlDbType.UniqueIdentifier);
                outPara.Direction = ParameterDirection.Output;

                SqlParameter[] allPara = new SqlParameter[5];
        ...
        public static bool Validate()
        {
            ...
            try
            {
                ...
                para[0] = new SqlParameter("@sessionToken", _sessionToken.Value);
