...

{
...

    {
...

        {
            ...
            bool hasProfitLoss = PrivilegeHelper.HasDisplayPrivilege(Program.userName, Program.braCode, WINDOW_ID_PROFIT_LOSS);

            bool hasBalanceSheet = PrivilegeHelper.HasDisplayPrivilege(Program.userName, Program.braCode, WINDOW_ID_BALANCE_SHEET);
...

        {
            ...
            if (!PrivilegeHelper.HasPrintPrivilege(Program.userName, Program.braCode, windowID))
